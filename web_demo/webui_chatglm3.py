    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(scale=2):
                chatbot = gr.Chatbot()
                user_input = gr.Textbox(show_label=False, placeholder="Input box...", lines=1)
                with gr.Row():
                    submitBtn = gr.Button("Submit", variant="primary")
                    resetBtn = gr.Button("Clear")
            with gr.Column(scale=2):
                ...
                search_field = gr.Textbox(show_label=False, placeholder="Search criteria...", lines=6)
